    ...
    >
      ...
      <div className="w-full max-w-xl relative z-10">
        ...
        <div className="mb-8 text-center">
          <span className="font-display text-4xl text-[#00ff41] glow tracking-widest">
            UZDYNAMICS
          </span>
          <p className="text-[#00ff41]/50 text-[10px] tracking-[0.4em] mt-1">
        ...
        {/* Progress bar */}
        <div className="border border-[#00ff41]/20 p-0.5">
          <motion.div
            className="h-1.5 bg-[#00ff41]"
        ...
        <div className="flex justify-between mt-1">
          <span className="text-[#00ff41]/40 text-[10px] tracking-widest">LOADING</span>
          <span className="text-[#00ff41]/70 text-[10px] tracking-widest">{progress}%</span>
        </div>
      </div>
    </motion.div>
  );
