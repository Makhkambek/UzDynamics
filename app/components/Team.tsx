...
const team = [
  {
    ...
    title:     "CO-FOUNDER",
    clearance: "ALPHA",
    bio:       "Leads software development and strategic operations at UzDynamics. Drives the architecture of autonomous control systems, mission-critical software pipelines, and long-term operational strategy. Focused on turning complex defense requirements into precise, deployable technology.",
    skills:    ["SOFTWARE_SYSTEMS", "STRATEGIC_OPS", "AUTONOMOUS_CTRL"],
  },
  {
    id:        "PERS-0042",
    initials:  "SS",
    ...
    title:     "CO-FOUNDER",
    clearance: "ALPHA",
    bio:       "Leads mechanical engineering and hardware design at UzDynamics. Responsible for the structural integrity, propulsion systems, and physical architecture of autonomous platforms — from UAV airframes to ground vehicle chassis built for extreme operational conditions.",
    skills:    ["MECHANICAL_ENG", "HARDWARE_DESIGN", "SYSTEMS_BUILD"],
  },
];
